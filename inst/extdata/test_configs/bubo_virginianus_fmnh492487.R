# Get specimen data
owl <- linkR_data('bubo_virginianus_fmnh492487')
...
# Animate linkage
anim <- animateLinkage(linkage, input.param=seq(-0.07,0.12,length=30), input.joint=1)

# Draw linkage
drawLinkage(anim, file='bubo_virginianus_fmnh492487.html', animate.reverse=TRUE)